#  INTERFAZ 4:
#  DIGITAL EN RASPBERRY (GPIOS)
#  ANALÓGICO CON ADS1115 
...
# GPIO RASP PARA LA PARTE DIGITAL
...
#ADS1115 SOLO ANALÓGICO (SIN ARDUINO)
...
#DECLARAR bus I2C y ADS1115
i2c = busio.I2C(board.SCL, board.SDA)
ads = ADS1115(i2c)

#Canales analógicos A0 y A1 del ADS1115
CH00=AnalogIn(ads, 0)
CH01=AnalogIn(ads, 1)

#GPIOS RASPBERRY (DIGITAL)
...
BTN_IN  = Button(22, pull_up=False)#D4 PUSH BUTTON

#CONEXIONES
#GPIO2 SDA - SDAS
#GPIO3 SCL - SCL
#PUENTES ENTRE GND Y ADDR PARA DIRECCION 0X48
...
#LECTURA ANALÓGICA ADS1115

    def GRF(self):
        try:
            v2 = CH00.voltage   # ADS1115 A0, en volts
            v3 = CH01.voltage   # ADS1115 A1, en volts
            if v2 is None:
                v2 = 0
            if v3 is None:
                v3 = 0
        ...
        #v2 y v3 ya están en Volts (0–3.3 V aprox)
        S2 = v2
        S3 = v3
